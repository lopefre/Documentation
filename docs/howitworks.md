Здесь описан ожидаемый порядок сборки итоговых документов, пути к исходникам, какие данные используются и как быстро внести изменения в тексты или графику без потери целостности сборки.
